...
const EventsCheckout = () => {
  return (
    <>
      <Helmet title="Events-Checkout" />
      {/* banner */}
      <section
            ...
            <div className="col-lg-8">
              <div className="checkout-widget d-flex flex-wrap align-items-center justify-cotent-between">
                <div className="title-area">
                  <h5 className="title">Already a App Idea Member?</h5>
                  <p>Sign in to earn points and make booking easier!</p>
                </div>
                <a href="/signin" className="sign-in-area">
              ...
              <div className="checkout-widget checkout-card mb-0">
                ...
                <ul className="payment-option">
                  <li className="active">
                    <a href="#0">
                      <img
                        src={require("../../assets2/assets/images/payment/card.png")}
                        alt="payment"
                      />
                  ...
                  <li>
                    <a href="#0">
                      <img
                        src={require("../../assets2/assets/images/payment/paypal.png")}
                        alt="payment"
                      />
                      <span>paypal</span>
                    </a>
