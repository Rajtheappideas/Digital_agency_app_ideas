...
const NewsDetails = () => {
  return (
    <>
      <Helmet title="News Details" />
      <TitleSection title="News Details" />
            ...
            <div className="content-side col-lg-8 col-md-12 col-sm-12">
              ...
              <div className="news-detail">
                <div className="inner-box">
                  <div className="image">
                    <img
                      //       src={require("../assets/images/resource/news-7.jpg")}
                      alt=""
                    />
                  </div>
                  <div className="lower-content">
                    ...
                    <div className="row clearfix">
                      <div className="column col-lg-6 col-md-6 col-sm-12">
                        <div className="image">
                          <img
                            //     src={require("../assets/images/resource/news-12.jpg")}
                            alt=""
                          />
                        </div>
                      </div>
                      <div className="column col-lg-6 col-md-6 col-sm-12">
                        <div className="image">
                          <img
                            //     src={require("../assets/images/resource/news-13.jpg")}
                            alt=""
                          />
                        </div>
                      </div>
                ...
                <div className="authors-box">
                  <div className="author-inner">
                    <div className="thumb">
                      <img
                        // src={require("../assets/images/resource/author-8.jpg")}
                        alt=""
                      />
                    </div>
                  ...
                  <div className="comment-box">
                    <div className="comment">
                      <div className="author-thumb">
                        <img
                          //   src={require("../assets/images/resource/author-1.png")}
                          alt=""
                        />
                      </div>
                  ...
                  <div className="widget-content">
                    <article className="post">
                      <figure className="post-thumb">
                        <img
                          //   src={require("../assets/images/resource/post-thumb-1.jpg")}
                          alt=""
                        />
                        <a href="/news-detail" className="overlay-box">
                    ...
                    <article className="post">
                      <figure className="post-thumb">
                        <img
                          //   src={require("../assets/images/resource/post-thumb-2.jpg")}
                          alt=""
                        />
                        <a href="/news-detail" className="overlay-box">
                          <span className="icon fa fa-link" />
                    ...
                    <article className="post">
                      <figure className="post-thumb">
                        <img
                          //   src={require("../assets/images/resource/post-thumb-3.jpg")}
                          alt=""
                        />
                        <a href="/news-detail" className="overlay-box">
                          <span className="icon fa fa-link" />
